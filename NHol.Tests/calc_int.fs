...
/// Tests for functions in the NHol.calc_int module.
module Tests.NHol.calc_int
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "calc_int"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "calc_int"
