...
/// Tests for functions in the NHol.realarith module.
module Tests.NHol.realarith
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "realarith"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "realarith"
