...
/// Tests for functions in the NHol.sets module.
module Tests.NHol.sets
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "sets"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "sets"
