...
/// Tests for functions in the NHol.calc_num module.
module Tests.NHol.calc_num
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "calc_num"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "calc_num"
