...
/// Tests for functions in the NHol.wf module.
module Tests.NHol.wf
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "wf"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "wf"
