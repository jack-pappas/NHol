...
/// Tests for functions in the NHol.recursion module.
module Tests.NHol.recursion
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "recursion"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "recursion"
