...
/// Tests for functions in the NHol.ind_types module.
module Tests.NHol.ind_types
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "ind_types"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "ind_types"
