...
/// Tests for functions in the NHol.calc_rat module.
module Tests.NHol.calc_rat
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "calc_rat"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "calc_rat"
    ...
    ModuleReset.arith ()
    ModuleReset.wf ()
    ModuleReset.calc_num ()
    ModuleReset.normalizer ()
    ModuleReset.grobner ()
    ModuleReset.ind_types ()
    ModuleReset.lists ()
    ModuleReset.realax ()
    ModuleReset.calc_int ()
    ModuleReset.realarith ()
    ModuleReset.real ()
    ModuleReset.calc_rat ()
