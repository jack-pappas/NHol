...
/// Tests for functions in the NHol.lists module.
module Tests.NHol.lists
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "lists"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "lists"
