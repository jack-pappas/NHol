...
/// Tests for functions in the NHol.int module.
module Tests.NHol.int
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "int"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "int"
