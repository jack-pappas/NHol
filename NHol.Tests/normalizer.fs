...
/// Tests for functions in the NHol.normalizer module.
module Tests.NHol.normalizer
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "normalizer"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "normalizer"
