...
/// Tests for functions in the NHol.iterate module.
module Tests.NHol.iterate
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "iterate"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "iterate"
