...
/// Tests for functions in the NHol.real module.
module Tests.NHol.real
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "real"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "real"
