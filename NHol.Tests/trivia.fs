...
/// Tests for functions in the NHol.trivia module.
module Tests.NHol.trivia
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "trivia"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "trivia"
