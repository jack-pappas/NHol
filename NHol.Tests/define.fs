...
/// Tests for functions in the NHol.define module.
module Tests.NHol.define
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "define"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "define"
