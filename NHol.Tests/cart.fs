...
/// Tests for functions in the NHol.cart module.
module Tests.NHol.cart
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "cart"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "cart"
