...
/// Tests for functions in the NHol.nums module.
module Tests.NHol.nums
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "nums"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "nums"
