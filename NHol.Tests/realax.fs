...
/// Tests for functions in the NHol.realax module.
module Tests.NHol.realax
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "realax"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "realax"
