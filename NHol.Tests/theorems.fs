...
/// Tests for functions in the NHol.theorems module.
module Tests.NHol.theorems
...
let fixtureSetup () : unit =
    ...
    SetupHelpers.emitEmptyTestFixtureSetupMessage "theorems"
...
let testSetup () : unit =
    ...
    SetupHelpers.emitTestSetupModuleResetMessage "theorems"
